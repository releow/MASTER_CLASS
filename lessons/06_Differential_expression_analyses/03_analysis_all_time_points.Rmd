...
counts_matrix <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/reanna/MASTER_CLASS/data/salmon.merged.gene_counts.tsv", header=TRUE, row.names=1)
...
# It is always good practice to check on NAs that can confound data type (character vs integer etc)
