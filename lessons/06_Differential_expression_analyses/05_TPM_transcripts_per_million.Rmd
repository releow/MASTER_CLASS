...
TPM <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/reanna/MASTER_CLASS/data/salmon.merged.gene_tpm.tsv", header=TRUE, row.names=1)

## also remove gene name column
TPM <- TPM %>%
  select(-gene_name)
...
# testing to see if I can get git to WORK PLEASE PLEASE PLEASE PLEASEEEEEEEE WORK
